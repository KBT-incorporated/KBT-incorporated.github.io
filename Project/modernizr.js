...
/*!
{
  ...
  "notes": [
    ...
    "softhyphens - tests that Â­ does its job",
    "softhyphensfind - tests that in-browser Find functionality still works correctly with Â­",
    {
  ...
  Modernizr.addAsyncTest(function() {
    ...
    function runHyphenTest() {
      ...
      addTest('softhyphens', function() {
        try {
          // use numeric entity instead of Â­ in case it's XHTML
          return test_hyphens('Â­', true) && test_hyphens('â€‹', false);
        } catch(e) {
          return false;
        }
      });
      ...
      addTest('softhyphensfind', function() {
        try {
          return test_hyphens_find('Â­') && test_hyphens_find('â€‹');
        } catch(e) {
          return false;
        }
      });
